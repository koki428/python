...
#for n in range(0,1):
    ...
    ax=ax1.pcolormesh(y*1.e-8,(x-rsun)*1.e-8,d.q2['vx'],vmax=500,vmin=-500,cmap='coolwarm',shading=shading)
    ax1.contour(y*1.e-8,(x-rsun)*1.e-8,d.q2['tu'],levels=[1.])
...
#                     ,fontsize=18,color='black')#,bbox=bbox_props)
    ...
    plt.pause(0.1)
    plt.savefig(pngdir+"py_bz_vx"+'{0:08d}'.format(n)+".png")
