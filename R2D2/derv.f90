!===================================================
subroutine d_x(qq,x,ix,jx,kx,qqd)
!===================================================
  implicit none
  ...
  real(8), dimension(ix) :: rk1,rk2,rk3,rk4

  real(8), dimension(ix,jx,kx), intent(out) :: qqd
...
!---------------------------------------------------
!===================================================
subroutine d_y(qq,y,ix,jx,kx,qqd)
!===================================================
  implicit none
  ...
  real(8), dimension(jx) :: rk1,rk2,rk3,rk4
...
!---------------------------------------------------
!===================================================
subroutine d_z(qq,z,ix,jx,kx,qqd)
!===================================================
  implicit none
  ...
  real(8), dimension(kx) :: rk1,rk2,rk3,rk4
