!============================================================
subroutine spherical2cartesian(qqs,rr,th,ph,ixs,jxs,kxs,ixc,jxc,kxc,qqc,xc,yc,zc)
!============================================================
    ...
    integer, intent(in) :: ixs,jxs,kxs
    integer, intent(in) :: ixc,jxc,kxc

    ! original spherical geometry
    real(8), dimension(ixs,jxs,kxs), intent(in) :: qqs
    real(8), dimension(ixs), intent(in) :: rr
    real(8), dimension(jxs), intent(in) :: th
    real(8), dimension(kxs), intent(in) :: ph

    real(8) :: drr,dth,dph
    real(8) :: drr0,dth0,dph0,drr1,dth1,dph1

    ! converted Cartesian geometry
    real(8), dimension(ixc,jxc,kxc), intent(out) :: qqc
    real(8), dimension(ixc), intent(out) :: xc
    real(8), dimension(jxc), intent(out) :: yc
    real(8), dimension(kxc), intent(out) :: zc
