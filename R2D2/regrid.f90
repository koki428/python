subroutine interp(x,y,z,xu,yu,zu,qq,ix,jx,kx,ixu,jxu,kxu,qu)
  !
  implicit none

  integer :: i,j,k
  integer, intent(in) :: ix,jx,kx,ixu,jxu,kxu
  real(8), dimension(ix), intent(in) :: x
  real(8), dimension(jx), intent(in) :: y
  real(8), dimension(kx), intent(in) :: z
  real(8), dimension(ixu), intent(in) :: xu
  real(8), dimension(jxu), intent(in) :: yu
  real(8), dimension(kxu), intent(in) :: zu
  
  real(8), dimension(ix ,jx ,kx ) :: qq
  real(8), dimension(ixu,jxu,kxu) :: qu
